...
BEGIN_MESSAGE_MAP(CMFCOpenGLApp, CWinAppEx)
...
// CMFCOpenGLApp 自定义加载/保存方法

void CMFCOpenGLApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CMFCOpenGLApp::LoadCustomState()
{
}

void CMFCOpenGLApp::SaveCustomState()
{
}
